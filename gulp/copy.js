...
gulp.task('copy:images', async function() {
    const copyTasks = [
        fs.copy('node_modules/@a-ui/core/src/images', '.tmp/images'),
    ];
...
gulp.task('copy:docs', async function() {
    const copyDocsTasks = [
        ...
        fs.ensureDir('docs/images'),
        fs.copy('node_modules/@a-ui/core/src/images', 'docs/images', { overwrite: false, errorOnExist: false }),
